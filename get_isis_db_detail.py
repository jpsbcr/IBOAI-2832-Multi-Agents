...
COMMAND_TO_RUN = "show isis database detail"

# --- Output File Configuration ---
OUTPUT_DIR = "llm_data_isis_db_detail" 
OUTPUT_FILENAME_PREFIX = "isis_db_detail"

# --- Script Logic ---
def collect_isis_db_detail_multi():
    try:
